const firebaseConfig = {
  apiKey: "AIzaSyDUPZtI37sz5gd5546d5YGYORPOXA8xvCk",
  authDomain: "graphical-password-auth.firebaseapp.com",
  projectId: "graphical-password-auth",
  databaseURL: "https://graphical-password-auth-default-rtdb.firebaseio.com",

  storageBucket: "graphical-password-auth.appspot.com",
  messagingSenderId: "629098430850",
  appId: "1:629098430850:web:45786394add8a8792e0f9b",
  measurementId: "G-WQXQH1P4WX",
};
// Initialize Firebase
    ...
    .on("value", function (snapshot) {
      if (snapshot.exists()) {
        ...
        document.querySelector(".alert").innerHTML =
          "Username does not exists Signup-->..";
    ...
    for (var i = 0; i < details.length; i++) {
      ...
      if (username.value == name) {
        if (passwd == txtpasswd) {
          ...
          document.querySelector(".alert").style.background = "red";
          document.querySelector(".alert").innerHTML =
            "Textual Password did not match..";
...
function getGPasswd() {
  ...
  function Data(data) {
    ...
    if (count < 3) {
      ...
      document.querySelector(".alert").style.background = "red";
      document.querySelector(".alert").innerHTML =
        "Point selection max limit reached..";
      location.reload();
      count = 0;
    }
  }
    ...
    for (var i = 0; i < details.length; i++) {
      ...
      if (username.value == name) {
        if (gpasswd == grphpasswd && txt_passwd.value != "") {
          ...
          document.querySelector(".alert").style.background = "red";
          document.querySelector(".alert").innerHTML =
            "Graphical Password did not match..";
          grph_passwd.value = "";
